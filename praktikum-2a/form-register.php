 ...
 <form method="POST" action="hasil-form-regis.php" class="container mt-5">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="*0110124139" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 angka">
      </div>
    </div>
  </div>
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="*Gibran Python" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
     ...
     foreach($ar_skill as $nama => $nilai ){
        ...
        echo "<input name='skills[]' id='skills_$nama'
        type='checkbox' class='custom-control-input' value='$nama'>";
  ...
  <div class="form-group row">
    <label for="dom" class="col-4 col-form-label">Domisili</label> 
    <div class="col-8">
      <select id="dom" name="dom" class="custom-select" required="required">
        <?php
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="*gibrangaming@gmail.com" type="email" class="form-control" required="required">
      </div>
    </div>
  </div> 
  <div class="form-group row">
